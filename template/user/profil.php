  ...
  <div class="container-md rounded bg-white mt-5 mb-5">
    <div class="row">
        <div class="col-md-3 border-right">
            ...
            <img class="rounded-circle mt-5" width="150px" height = "150px" src = "">
            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="password" name = "password" class="form-control" placeholder= "Password Belum Diubah" value="">
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name = "verif" class="form-control" disabled value="">
                    </div>
                </div>
