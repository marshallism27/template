    ...
    <div class="col-md-5 border-right">
        <div class="p-3 py-5">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="text-right">Form Peminjaman</h4>
            </div>
                </div>
                <div class="row mt-3">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <label class="labels">Tanggal Peminjaman</label>
                    <input name="t_kembali" type="date" class="form-control" value="<?= date('Y-m-d H:i:s')?>">
                </div>
                <div class="col-md-12">
                    <label class="labels">Kondisi Buku</label>
                    <select class = "form-select" name="k_buku_p" id="">
            ...
            <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name ="submit">Submit</button></div>
            </div>
        </div>
    </div>
</div>
